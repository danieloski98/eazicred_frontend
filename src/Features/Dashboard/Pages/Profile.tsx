            ...
            <div className="main__form flex xl:flex-row-reverse lg:flex-row-reverse md:flex-col sm:flex-col mt-10">
              ...
              <div className="flex-1 w-full">
                <div className="input-group flex flex-col">
                    ...
                    <input  name="newpassword" id={'newpassword'} type="text" placeholder="**********" className="xl:w-3/5 lg:w-3/5 md:w-full sm:w-full rounded-lg border-2 border-gray-200 h-16 mt-3 p-3"/>
              </div>
              </div>
              ...
              <div className="input-groups flex-1 xl:mt-0 lg:mt-0 md:mt-10 sm:mt-10">
                <div className="input-group flex flex-col">
                    ...
                    <input name="oldpassword" id={'oldpassword'} type="text" className="xl:w-3/5 lg:w-3/5 md:w-full sm:w-full rounded-lg border-2 border-gray-200 h-16 mt-3 p-3" />
                </div>
                <div className="input-group mt-10 flex flex-col">
                    <label htmlFor={'newpassword'}>Phone</label>
                    <input  name="newpassword" id={'newpassword'} type="text" className="xl:w-3/5 lg:w-3/5 md:w-full sm:w-full rounded-lg border-2 border-gray-200 h-16 mt-3 p-3" />
                </div>
              </div>
